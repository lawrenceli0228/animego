...
// importing the full @types/library/types.js typedef chain.
 ...
 * pill self-gate.
 */
export function ImportMiniPill({
  status,
  progress,
  summary,
  onExpand,
...
const s: Record<string, React.CSSProperties> = {
  pill: {
    ...
    cursor: "pointer",
    boxShadow:
      "0 8px 24px rgba(0,0,0,0.50), 0 0 0 1px rgba(10,132,255,0.18)",
