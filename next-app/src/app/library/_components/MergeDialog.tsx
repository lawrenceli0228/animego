...
// Local copy of the Series shape we use — the full type lives in
// lib/library/types.js (JSDoc only). Kept loose intentionally; callers
// already pass the typed Series via the hook chain.
