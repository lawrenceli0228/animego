...
const s = {
  ...
  availBadge: (kind: SeriesAvailability): React.CSSProperties => ({
    ...mono,
    position: "absolute",
    top: 32,
    left: 8,
  ...
  progressTextDone: { color: "#30d158" } as React.CSSProperties,
  progressTextNew: {
    fontSize: 9,
    color: PROGRESS_FILL,
...
function SeriesCard({
  ...
  const safePoster =
    typeof series.posterUrl === "string" && /^https:\/\//i.test(series.posterUrl)
      ? series.posterUrl
      : null;
  ...
  function fire(action: OverrideAction) {
    setMenuOpen(false);
      ...
      >
        ...
        <div style={s.posterWrap}>
          ...
          <span style={s.localBadge} data-testid="local-badge">
            <span aria-hidden style={s.localGlyph}>
              {LOCAL_HEX_GLYPH}
            </span>
            LOCAL
          </span>
            ...
            <span
              ...
              title={
                availability === "offline"
                  ? t("library.card.offline")
                  : t("library.card.partial")
              }
            >
          ...
          {(progressLabel || isNew) && (
            <span
              style={{
                ...
                ...(progressPct != null && progressPct >= 1
                  ? s.progressTextDone
                  : null),
              }}
        ...
        {compact ? (
          ...
          <div style={s.body}>
            <div style={s.titleRow}>
              ...
              {isLocked && (
                <span style={s.lockedBadge} data-testid="locked-badge">
                  LOCK
                </span>
              )}
            </div>
