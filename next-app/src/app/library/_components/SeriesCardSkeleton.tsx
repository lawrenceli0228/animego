...
import { PLAYER_HUE } from "@/components/landing/shared/hud-tokens";
...
const s = {
  ...
  bar: (w: string, h: number = 10): React.CSSProperties => ({
    height: h,
    width: w,
    borderRadius: 3,
  ...
  return (
    ...
    >
      <div style={s.poster}>
        <div
          style={s.shimmer}
          data-skeleton-shimmer={reduced ? "false" : "true"}
        />
      </div>
