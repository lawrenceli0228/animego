...
function useWatchRhythm({ db }) {
  ...
  useEffect(() => {
    ...
    if (typeof indexedDB === 'undefined') {
      // TODO P6 verify: React 19 lint flags setState directly inside effect.
      // Legacy useWatchRhythm.js sets `loaded: true` here so callers exit the
      // pending-state branch in jsdom/test envs. Parity rules require
      // byte-identical behavior; the call only fires once per mount.
...
export { useWatchRhythm };
export default useWatchRhythm;
