 ...
 *
 * The frame is purely chrome — no playback callbacks, no engine state. Forwards
 * all player props verbatim. Ported from legacy
 * client/src/components/player/PlayerHudFrame.jsx.
 */
 ...
 */
function useTypeOn(text: string, charIntervalMs = 18): string {
...
export interface PlayerHudFrameProps {
  ...
  onEnded: () => void;
  onPlaybackError: (err: { kind?: string } | null) => void;
