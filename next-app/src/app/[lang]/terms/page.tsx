...
// Chinese-only body, deliberately — see the note in ../privacy/page.tsx.
// These terms are what a user agrees to; a machine translation of them would
// be a different agreement. Metadata is locale-aware, the document is not, and
// keeping the legal pages out of the hreflang set is the follow-up that
