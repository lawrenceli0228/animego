...
import { runImport } from '../_services/importPipeline.js';
...
/** @typedef {import('../_services/importPipeline').ImportSummary} ImportSummary */
 ...
 * }}
 */
export function useImport({ db, dandan, hashPool: injectedPool }) {
