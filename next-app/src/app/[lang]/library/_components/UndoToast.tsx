...
// Ported from client/src/components/shared/UndoToast.jsx. 5s auto-dismiss
// toast with hover-pause and an [撤销] action. Lives in _components for the
// Library surfaces; if/when a shared UI lib emerges we can promote it.
...
const s = {
  ...
  countdownFill: (pct: number): CSSProperties => ({
    height: "100%",
    width: `${pct * 100}%`,
    ...
    >
      ...
      >
        ...
        <div style={s.body}>
          ...
          {meta && (
            <span style={s.meta} data-testid={`${testId}-meta`}>
              {meta}
            </span>
          )}
        </div>
