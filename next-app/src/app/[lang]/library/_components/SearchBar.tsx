...
const s = {
  wrap: (focused: boolean): React.CSSProperties => ({
    position: "relative",
    display: "inline-flex",
    alignItems: "center",
    gap: 8,
    ...
    borderRadius: 12,
    transition:
      "background 150ms ease-out, border-color 150ms ease-out, width 200ms cubic-bezier(0.4,0,0.2,1)",
...
const SearchBar = forwardRef<SearchBarHandle, SearchBarProps>(function SearchBar(
  ...
  return (
    <div
      style={s.wrap(focused || value.length > 0)}
