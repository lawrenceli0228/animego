const en = {
  ...
  torrent: {
    ...
    folderGuideTitle: 'Download to one folder',
    folderGuideBody: 'Keep your downloader pointed at one folder, then choose that folder in My Library. Finished downloads appear automatically.',
    folderGuideCta: 'Set up library',
  },
  playerGuide: {
  ...
  communityDiscovery: {
    ...
    libraryGuideEyebrow: 'PLAYER GUIDE',
    libraryGuideTitle: 'Download to one folder. My Library keeps up.',
    libraryGuideBody: 'No repeated dragging: give your downloader a fixed save folder, then let My Library remember the same folder.',
    libraryGuideStepDownload: 'Open Torrents on an anime page and start the download.',
    libraryGuideStepFolder: 'The first time, open My Library in desktop Chrome and choose the download folder.',
    libraryGuideStepRefresh: 'Keep or return to My Library when it finishes; new episodes appear automatically.',
  ...
  library: {
    ...
    drop: {
      ...
      sub1: "We'll detect the anime, group them into series, and line up the episodes.",
      sub2: 'Videos stay on your device. Nothing uploads.',
      cta: 'Choose folder',
      ariaIdle: 'Drop a folder here or click to choose',
      ariaHover: 'Ready to receive folder',
      ariaParsing: 'Importing',
      hoverTitle: 'Release to start',
      hoverDetected: 'Detected ',
      hoverFolder1: '1 folder',
      hoverEstimateMid: ' · about ',
      hoverFiles: ' media files',
      parsingTitle: 'Parsing…',
      parsingCancel: '⊘ Cancel',
      parsingProgressLabel: 'File parse progress',
    ...
    filter: {
      ...
      almostDoneHint: '≥80%, not finished',
      stalled: 'Stalled',
      stalledHint: 'No activity in 7d',
      fresh: 'Just started',
      freshHint: '<10%',
      clear: 'Clear',
      aria: 'Library filters',
    },
    search: {
      placeholder: 'Search series…',
      aria: 'Search local library',
      clear: 'Clear search',
    },
    bulk: {
      aria: 'Bulk actions',
      ...
      delete: 'Delete',
      mergeIntoSeries: 'Merge into series',
    },
    rhythm: {
      cadenceLabel: '// CADENCE',
      epsThisWeek: 'eps this week',
      daysStreak: 'day streak',
      cal14Aria: 'Last 14 days: {{days}} day(s) with activity',
    },
    row: {
      continueWatching: '// CONTINUE //',
      newAdditions: '// RECENTLY ADDED //',
    ...
    actionsMenu: {
      mergeTo: 'Merge into another series…',
      splitThis: 'Split this series…',
      rematch: 'Rematch…',
      opsLog: 'Operation log',
      delete: 'Delete…',
    },
    overflow: {
    ...
    importDrawer: {
      ...
      privacyLocal: 'All parsing is local',
      title: 'Import local files',
      close: 'Close',
      clusterCount: '{{total}} clusters · {{pct}}% done',
      ...
      warnAmbiguous: '{{count}} need picking',
      cancelBtn: 'Cancel import',
      backgroundBtn: 'Run in background',
      doneBtn: 'Done',
    },
    ...
    opsLog: {
      ...
      close: 'Close',
      empty: 'No recent activity for this series',
      kindMerge: 'Merge',
      kindSplit: 'Split',
      kindRematch: 'Rematch',
      kindUnfile: 'Unfile',
      ...
      timeDaysAgo: '{{n}}d ago',
      summaryMergeBoth: 'Merged {{source}} → {{target}}',
      summaryMergeTarget: 'Merged into {{target}}',
      summaryMerge: 'Merge',
      summarySplitName: 'Split into new series "{{name}}"',
      summarySplit: 'Split series',
      summaryRematchTarget: 'Rematched to {{target}}',
      summaryRematch: 'Rematch',
      summaryUnfile: 'Removed from series',
      summaryDelete: 'Delete',
    },
    // Confirm / toast strings in LibraryShell & LocalSeriesShell
    confirm: {
      deleteSingle: 'Remove "{{title}}" from library?\n\nThis clears local metadata, progress, and overrides. Your video files on disk are not touched.',
      deleteBulkPreviewMore: '… ({{total}} total)',
      deleteBulk: 'Remove {{count}} items from library?\n\n{{preview}}\n\nThis clears local metadata, progress, and overrides. Your video files on disk are not touched.',
      resetLibrary: 'Clear the entire local library? This deletes all series, episodes, fileRefs, matchCache, fileHandles, and opsLog.\n(Video files on disk are not touched.)',
    },
    toast: {
      deleteSuccess: 'Removed "{{title}}"',
      deleteSuccessCount: 'Removed {{count}} items',
      deleteSuccessPartial: 'Removed {{ok}} of {{total}} items — some failed',
      deleteFailed: 'Delete failed, please try again',
      mergeFailed: 'Merge failed, please try again',
      dedupeNone: 'No duplicate series found',
      dedupeSkipped: 'Detected {{groups}} duplicate group(s) — all already merged (skipped {{skipped}})',
      dedupeSuccess: 'Merged {{merged}} items across {{groups}} duplicate group(s)',
      danmakuUpdated: 'Danmaku source updated',
      danmakuUpdateFailed: 'Update failed',
    },
    undoToast: {
      mergeFromSource: 'Merged from {{source}}',
      mergeBulkTitle: 'Merged into {{target}}',
      mergeBulkMeta: '{{count}} items',
      dedupeBulkTitle: 'Merged duplicates ({{count}} items)',
      dedupeBulkMeta: '{{groups}} groups · same animeId',
      autoMergeMeta: 'From {{folderCount}} folder(s) ({{folderLabels}})',
      kicker: 'Merged',
      undoLabel: 'Undo',
      viewLabel: 'View',
    },
    ...
    localSeries: {
      ...
      notFound: 'This series no longer exists or has been removed',
      backToLibrary: 'Back to library',
      rootFolder: '(root)',
    },
    // SplitDialog
    ...
    unavailable: {
      ...
      reauthTitle: 'Reauthorize each offline folder via the browser native picker',
      reauthorizing: 'Authorizing…',
      reauthorize: 'Reauthorize',
      refreshTitle: 'Re-probe drive connection (no auth prompt)',
      refreshing: 'Detecting…',
      refresh: 'Refresh availability',
      reasonPartial: 'Some episodes missing',
      reasonOffline: 'Drive disconnected',
      openBtn: 'Open',
      deleteBtn: 'Remove',
      deleteTitle: 'Remove from library (disk files untouched — re-import when reconnected)',
    },
    // SeriesDetailSheet
    detail: {
      close: 'Close',
      epCount: '{{count}} eps',
      watched: '{{done}}/{{total}} watched',
      resumeBtn: '▶ Resume EP {{ep}}',
    ...
    // ImportMiniPill
    miniPill: {
      ariaLabel: 'Expand import progress drawer',
      importing: 'Importing',
      expand: 'Expand ↗',
    },
    access: {
