const en = {
  ...
  detail: {
    ...
    infoStudio: 'Studio',
    infoLinks: 'Links',
    infoSynonyms: 'Also known as',
    infoProducers: 'Producers',
    infoTags: 'Tags',
    popularity: 'On {{n}} lists',
    nextEpisode: 'Episode {{ep}}',
    airsInDays: 'in {{n}}d',
    airsInHours: 'in {{n}}h',
    airsInMinutes: 'in {{n}}m',
    airsSoon: 'airing now',
    scores: 'Scores',
    votes: 'ratings',
    ...
    watchTrailerAria: 'Play the official trailer for {{title}}',
    closeTrailer: 'Close trailer',
    openTrailerOnYouTube: 'Watch on YouTube',
    relations: 'Relations',
  ...
  landing: {
    ...
    features: {
      ...
      title: 'Eight things, done on purpose.',
      ...
      f8Eyebrow: '08 · Member Pass', f8Title: 'Your pass, your face.',
      f8Body: 'A holographic member card that is yours to shape — upload a card photo, pick a profile backdrop from shows you have watched, preview live, and your nav avatar follows.',
      f8PhotoLabel: 'Card photo',
      f8PhotoHint: 'Upload your photo',
      f8PickLabel: 'Profile backdrop',
      f8SyncLabel: 'Set once, synced everywhere',
      f8Sync1: 'Navbar avatar',
      f8Sync2: 'Comment identity',
      f8Sync3: 'Profile backdrop',
      f8PreviewLabel: 'Profile preview',
      f8PreviewWatched: 'watched',
      f8Cta: 'Customize my pass →',
      srcA: 'Source A · 1080p',
    ...
    openSource: {
      eyebrow: 'Danmaku × Open Source / The sound of one frame · code on the table',
      title: 'Danmaku on screen, source in the open.',
      sub: 'The player you are watching: live danmaku across the same frame, manual episode picking as a fallback — and the whole repo (front end, player, tracking, self-host) is AGPL-3.0. Read it, run it, fork it.',
      liveLabel: 'LIVE',
      frameTag: 'OPEN SOURCE · AGPL-3.0',
      starWord: 'Star',
      starAria: 'Star on GitHub',
      waysLabel: '// where you can help:',
      way1: 'Local player',
      way2: 'Danmaku sync',
      way3: 'Tracking / discovery',
      way4: 'i18n',
      way5: 'Self-host',
      way6: 'Design / a11y',
      ctaSource: 'View source',
      ctaSelfHost: 'Self-host guide',
      ctaContributing: 'Contributing',
      ctaLicense: 'AGPL-3.0 license',
    },
    faq: {
      eyebrow: 'FAQ',
  ...
  library: {
    ...
    refreshMeta: 'Update series info',
    refreshMetaProgress: 'Updating series info ({{done}}/{{total}})',
    refreshMetaDone: 'Updated {{changed}} of {{total}} series',
    refreshMetaNothing: 'All series info already current',
    refreshMetaFailed: 'Update failed: {{error}}',
    // Buttons + copy for the "files unavailable" collapsible section.
    // These keys were never defined before — t() falls back to the raw key,
    // so buttons literally rendered "library.unavailable.refresh".
    unavailable: {
      count: "{{count}} series' files can't be opened right now",
      reauthorize: 'Re-allow access',
      reauthorizing: 'Waiting for permission…',
      reauthTitle: 'The browser forgot its folder permission — click to re-allow',
      refresh: 'Check again',
      refreshing: 'Checking…',
      refreshTitle: 'Re-check whether the drives and folders are reachable',
      reasonOffline: 'Drive not connected',
      reasonPartial: 'Some files are missing',
      openBtn: 'View',
      deleteBtn: 'Remove from library',
      deleteTitle: 'Remove from the library (your files on disk stay untouched)',
    },
    // §5.x v4 DropZone
    drop: {
    ...
    overflow: {
      ...
      dedupeBusy: 'Merging…',
      refreshAvail: 'Check drive connection',
      refreshAvailBusy: 'Checking…',
