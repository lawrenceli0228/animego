const zh = {
  ...
  detail: {
    ...
    officialTrailer: '官方预告',
    watchTrailer: '观看预告',
    watchTrailerAria: '播放《{{title}}》的官方预告',
    closeTrailer: '关闭预告',
    openTrailerOnYouTube: '在 YouTube 观看',
    relations: '关联作品',
    characters: '角色 & 配音',
    voiceActorLang: '日语',
    staff: '制作人员',
  ...
  hub: {
    ...
    next: '下一页 →',
    noAnime: '暂无番剧',
    metaSuffix: '按人气排序，评分、集数、剧情简介一站搞定。',
  },
  seasonPage: {
    title: '季度番剧',
    noAnime: '暂无番剧',
  ...
  landing: {
    ...
    features: {
      ...
      f7AcceptsLabel: '支持',
      f7Cta: '进播放器试一下 →',
      f8Eyebrow: '08 · 会员通行证', f8Title: '你的卡,你做主。',
      f8Body: '一张全息会员卡 —— 卡面照片你上传,主页背景从追过的番里挑,改完实时预览,连导航头像一起换。',
      f8PhotoLabel: '卡面照片',
      f8PhotoHint: '上传你的照片',
      f8PickLabel: '主页背景',
    ...
    openSource: {
      eyebrow: 'Danmaku × Open Source / 一帧的声 · 把代码摆上桌',
      title: '弹幕同屏,源码开放。',
      sub: '你正在看的这个播放器:弹幕同屏、手动选集兜底,而前端、播放器、追番、自部署整库 AGPL-3.0 —— 读它、跑它、fork 它。',
      liveLabel: 'LIVE',
      frameTag: '开源 · AGPL-3.0',
      starWord: 'Star',
      ...
      ctaSource: '查看源码',
      ctaSelfHost: '自部署指南',
      ctaContributing: '贡献指南',
      ctaLicense: 'AGPL-3.0 许可',
    },
    faq: {
      eyebrow: 'FAQ / 常见疑问',
      title: '回答一些你可能在想的事。',
  ...
  library: {
    ...
    refreshMeta: '更新番剧信息',
    refreshMetaProgress: '更新番剧信息 ({{done}}/{{total}})',
    refreshMetaDone: '已更新 {{changed}} / {{total}} 部番剧',
    refreshMetaNothing: '番剧信息都已是最新',
    refreshMetaFailed: '更新失败:{{error}}',
    // 「文件不可用」折叠区(硬盘拔了 / 授权掉了)的按钮与说明。
    // 这些 key 此前从未定义,t() 缺省直接渲染原始 key —— 按钮上曾显示
    // "library.unavailable.refresh" 这类天书,故整块补齐。
    unavailable: {
      count: '{{count}} 部番剧的文件暂时打不开',
      reauthorize: '重新授权',
      reauthorizing: '授权中…',
      reauthTitle: '浏览器忘记了文件夹的访问许可,点这里重新允许',
      refresh: '再查一次',
      refreshing: '检查中…',
      refreshTitle: '重新检查硬盘和文件夹是否能访问',
      reasonOffline: '硬盘没连接',
      reasonPartial: '部分文件找不到了',
      openBtn: '查看',
      deleteBtn: '移出库',
      deleteTitle: '从库里移除(不会删除你电脑上的文件)',
    },
    // §5.x v4 DropZone
    drop: {
      title: '把文件夹拖到这里',
    ...
    overflow: {
      ...
      dedupe: '合并重复',
      dedupeBusy: '合并中…',
      refreshAvail: '重新检查硬盘连接',
      refreshAvailBusy: '检查中…',
      rescan: '重新扫描文件夹',
      rescanBusy: '扫描中…',
      reset: '重置库',
      refreshMetaBusy: '更新中…',
