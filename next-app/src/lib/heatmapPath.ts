 ...
 *
 * P6.6 port note: ts-nocheck'd because the artplayer plugin queue shape is
 * dynamic and untyped upstream — strict typing would force speculative
 * interfaces without reading the plugin source. Pure-function module shared
 * by VideoPlayer (production) and HeatmapTuner (dev-only live tuning).
 */
