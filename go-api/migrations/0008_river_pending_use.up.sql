-- 0008_river_pending_use.up.sql
--
-- river v0.37.1 internal migrations 005..006, which reference the
-- 'pending' enum value added in 0007.  Separate transaction required;
-- see 0007_river_initial.up.sql header for the ENUM-add-vs-use rule.
