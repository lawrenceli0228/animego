...
function EnrichmentBar({ v0, v1, v2, total }) {
...
function VersionBadge({ version }) {
  ...
  return <span style={S.badge('#ff453a')}>v{version}</span>
}
    ...
    <div className="container" style={S.container}>
      ...
      {stats && (
        <div style={S.statsGrid}>
          ...
          <EnrichmentBar v0={stats.enrichment.v0} v1={stats.enrichment.v1} v2={stats.enrichment.v2} total={stats.anime} />
        </div>
      )}
